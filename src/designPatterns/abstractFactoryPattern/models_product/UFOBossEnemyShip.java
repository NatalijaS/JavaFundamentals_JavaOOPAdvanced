package designPatterns.abstractFactoryPattern.models_product;

import designPatterns.abstractFactoryPattern.factory_creator.EnemyShipFactory;

public class UFOBossEnemyShip extends EnemyShip {

    // We define the type of ship we want to create
    // by stating we want to use the factory_creator that
    // makes enemy ships
