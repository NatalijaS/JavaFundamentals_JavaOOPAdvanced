...
import designPatterns.abstractFactoryPattern.models_product.UFOBossEnemyShip;
import designPatterns.abstractFactoryPattern.models_product.UFOEnemyShip;
...
public class UFOEnemyShipBuilding extends EnemyShipBuilding {
    ...
    protected EnemyShip makeEnemyShip(String typeOfShip) {
        ...
        // If UFO was sent grab use the factory_creator that knows
        ...
        if(typeOfShip.equals("UFO")){
            ...
            // If UFO BOSS was sent grab use the factory_creator that knows
