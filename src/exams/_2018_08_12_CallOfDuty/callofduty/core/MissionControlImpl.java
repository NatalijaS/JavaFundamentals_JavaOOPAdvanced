    ...
    private void initMissionClasses() {
        try {
            this.missionClasses = new LinkedHashMap<String, Class>() {{
                put("EscortMission", Class.forName("exams._2018_08_12_CallOfDuty.callofduty.domain.missions.EscortMission"));
                put("HuntMission", Class.forName("exams._2018_08_12_CallOfDuty.callofduty.domain.missions.HuntMission"));
                put("SurveillanceMission", Class.forName("exams._2018_08_12_CallOfDuty.callofduty.domain.missions.SurveillanceMission"));
            }};
